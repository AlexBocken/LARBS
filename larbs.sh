...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/AlexBocken/dotfiles"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/AlexBocken/LARBS/master/progs.csv"
